...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.custom_template_path'
        db.add_column(u'channels_channel', 'custom_template_path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.custom_template_path'
        db.delete_column(u'channels_channel', 'custom_template_path')
    ...
    models = {
        ...
        u'channels.channel': {
            ...
            'custom_template_path': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
